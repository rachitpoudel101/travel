...
export default class guidereport extends Component {
    ...
    render() {
        ...
        return (
            ...
            <div className="container p-3 mb-2 bg-white text-black">

                <h2 className="text-center"><strong> Tourguides Reports</strong></h2>
 ...
 < button type="button" className="btn btn-primary" style={{marginTop:'15px', width:'200px', margin:'10px', color:"white", borderRadius:'20px'}}  onClick={this.repotGen}><strong>Print Report</strong></button>
 <a href="/view" className="btn btn-primary" style={{marginTop:'15px', width:'200px', margin:'10px', color:"white", borderRadius:'20px'}}><strong>User View</strong></a>
            </div>
